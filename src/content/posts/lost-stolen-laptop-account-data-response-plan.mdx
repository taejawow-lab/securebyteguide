...
sources:
  ...
  - title: "Secure a Hacked or Compromised Google Account"
    ...
    year: "2026 accessed"
internalLinks:
  - "/posts/session-cookie-theft-infostealer-account-recovery-plan/"
...
![An encrypted storage device protected inside a rigid transparent enclosure](/images/illustrations/sbg-lost-laptop-20260901-02.png)
...
For a provider-by-provider sequence, use the [session-cookie theft recovery plan](/posts/session-cookie-theft-infostealer-account-recovery-plan/). Email persistence deserves the [hidden-forwarding recovery checklist](/posts/compromised-email-hidden-forwarding-recovery-plan/). After the incident, build a [family recovery binder without shared passwords](/posts/family-account-recovery-passkey-binder-without-leaking-secrets-2026/). If a phone or authenticator was in the same bag, follow the [authenticator migration plan](/posts/old-smartphone-authenticator-migration-before-trade-in-2026/) before removing it.
...
![A closed laptop, backup storage, and recovery materials kept in separate compartments](/images/illustrations/sbg-lost-laptop-20260901-04.png)
