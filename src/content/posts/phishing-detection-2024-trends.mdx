...
For complementary defenses, see the companion posts on [2FA methods compared](/posts/2fa-methods-compared-data) (Google's effectiveness data) and family password managers compared (the credential-management foundation that determines whether phishing succeeds).
